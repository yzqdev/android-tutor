...
//                    date = mUserToDoItem.getToDoDate();
                ...
                datePickerDialog.show(requireActivity().getSupportFragmentManager(), "DateFragment");
...
//                    date = mUserToDoItem.getToDoDate();
                ...
                timePickerDialog.show(requireActivity().getSupportFragmentManager(), "TimeFragment");
            }
        });
