...
import com.yzq.todo.Reminder.ReminderActivity;

import java.util.UUID;

public class TodoNotificationService extends IntentService {
    public static final String TODOTEXT = "com.yzq.todonotificationservicetext";
    public static final String TODOUUID = "com.yzq.todonotificationserviceuuid";
