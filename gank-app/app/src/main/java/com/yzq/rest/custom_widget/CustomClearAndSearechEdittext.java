 ...
 */
public class CustomClearAndSearechEdittext extends AppCompatEditText implements View.OnFocusChangeListener,TextWatcher{
    ...
    private void init(final Context context) {
        ...
        final Drawable drawable = ContextCompat.getDrawable(context, R.drawable.ic_collection_24dp);
